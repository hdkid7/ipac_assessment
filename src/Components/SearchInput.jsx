export default function SearchInput({submitHandlerFn, searchQueryHandler, query, isLoading}) {
    return(
        <form className="max-w-md mx-auto mt-10" onSubmit={(e) => submitHandlerFn(e)} onChange={(e) => searchQueryHandler(e.target.value)}>
            ...
            <div className="relative">
                ...
                <input type="search" id="default-search"
                       ...
                       placeholder="Search biological features..." />
